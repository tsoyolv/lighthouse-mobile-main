...
import ru.lighthouse.mobile.main.core.dao.AbstractDomainService;
...
public abstract class AbstractDomainHistoryService
        <T extends HistoricalDomainModel, TR extends JpaRepository<T, Long> & JpaSpecificationExecutor<T>, H extends HistoryDomainModel, HR extends HistoryRepository<H>>
        extends AbstractDomainService<T, TR> {
    private final boolean historyEnabled;
    private final Integer historyLength;
    protected final HR historyRepository;

    public AbstractDomainHistoryService(TR repository, HR historyRepository, String historyEnabled, String historyLength) {
        super(repository);
