...
public abstract class AbstractDomainService<T extends DomainModel, R extends JpaRepository<T, Long> & JpaSpecificationExecutor<T>> implements DomainService<T> {
